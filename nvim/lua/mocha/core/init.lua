...
-- Required tools
local required_externals = { 'rg', 'git', 'curl' }
local optional_externals = {}
...
function M.setup(opts)
  local colorscheme = require('mocha.core.colorscheme')
  local command = require('mocha.core.command')
  local config = require('mocha.core.config')
  local plugin = require('mocha.core.plugin')
  local reload = require('mocha.core.reload')
